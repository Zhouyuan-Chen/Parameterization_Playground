...
int main(int argc, char** argv)
{
    ...
    polyscope::getSurfaceMesh("3D domain")->addVertexParameterizationQuantity("uv_dp", dp_uv);
    ...
    polyscope::getSurfaceMesh("BFF 2D domain")
        ->addVertexParameterizationQuantity("uv", dp.get_bff_uv());
